...
# Example DataFrames
dfs = [final_df, final_df_nobill, final_df_404, final_df_500, final_df_400, final_nomemId]  # Replace with your actual DataFrames
object_names = ['BillsLatestStage_ID.csv','BillsLatestStage_IDNoBill.csv','BillsLatestStage_ID404.csv', 'BillsLatestStage_ID500.csv', 'BillsLatestStage_ID400.csv','BillsLatestStage_NoMemId.csv']  # Replace with your desired S3 object names
